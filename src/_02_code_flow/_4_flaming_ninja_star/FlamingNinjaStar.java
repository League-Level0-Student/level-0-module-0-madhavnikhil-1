...
public class FlamingNinjaStar {
	public static void main(String[] args) {
		...
		Robot Pallav = new Robot();
		Pallav.penDown();
		// Set the robot speed to 100
		Pallav.setSpeed(100);
		// Set the robot window size to 800 x 800
		Pallav.setWindowSize(800, 800);
		...
		while (Javoo < 1) {
			...
			Pallav.move(64);
			Pallav.turn(-40);
			Pallav.setPenColor(Color.YELLOW);
			Pallav.move(flameSize);
			Pallav.turn(170);
			Pallav.move(flameSize);
			Pallav.turn(64);
			Pallav.setPenColor(Color.BLACK);
			Pallav.move(baseSize);
			Javoo += 1;
		}
